  ...
  return (
    ...
    <table >
        ...
        <tr>  
          ...
          <td style={{paddingLeft:"50px"}}>
            <p>{"Your funds will be reflected on your wallet as soon as your contribution is received and has been confirmed on the network. If you don’t receive the tokens, contact an admin on"} <Link activeClassName="active" sx={{color: '#905bc4','&.visited': {color: '#905bc4'}}}  to="https://discord.gg/gNFfBfV4he" target="_new">Discord</Link> or <Link sx={{color: '#905bc4','&.visited': {color: '#905bc4'}}} to="https://t.me/elysianfinance" target="_new">Telegram.</Link>
            <br /><span style={{color:"#905bc4"}}><Link activeClassName="active" onClick={addTokenToMetamask}>Add token to Metamask</Link></span></p>
          </td>
        </tr> 
        <tr>  
      <td>
