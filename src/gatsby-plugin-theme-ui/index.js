const Theme = {
  ...
  colors: {
    text: '#F9F9F9', // body color and primary color
    text_secondary: '#F9F9F9', // secondary body color
    heading: '#F9F9F9', // primary heading color
    heading_secondary: '#83a1af', // heading color
    background: '#150E1C', // body background color
    background_secondary: '#150E1C', // secondary background color
